        ...
        <div className="persona-grid-view-testimonial">
          <div className="persona-grid-view-container2">
            <h1 className="persona-grid-view-text">
              <span>Our Persona</span>
              <br></br>
            </h1>
            <span className="persona-grid-view-text3">
              From Electrical Engineers designing efficient power systems to
              Consumer Electronics Developers enhancing device performance,
              discover how our resources can elevate your projects.
            </span>
            <div className="persona-grid-view-container3">
              <PersonaCard
                ...
                name="Battery Pack CAD Modelling"
              ...
              <PersonaCard
                ...
                name="Battery Management System (BMS) Design"
                quote="Development of efficient and reliable BMS design tailored to optimize battery performance and safety."
              ></PersonaCard>
              <PersonaCard
                ...
                name="Battery Pack Failure Analysis"
              ...
              <PersonaCard
                ...
                name="Battery Thermal Management System Design"
                quote="Customized design of thermal management systems to optimize battery performance and lifespan."
              ></PersonaCard>
              <PersonaCard
                ...
                name="Battery Pack Range Prediction"
                quote="Utilization of predictive modeling to estimate battery pack range under various conditions and usage scenarios."
              ></PersonaCard>
              <PersonaCard
                ...
                name="Battery Pack Heat Flow Prediction & CFD Simulation"
                quote="Advanced Computational Fluid Dynamics (CFD) simulation for accurate prediction of heat flow within battery packs."
              ></PersonaCard>
              <PersonaCard
                ...
                name="Battery Pack Lightweighting"
                quote="Development of lightweight battery pack designs to enhance overall vehicle efficiency and performance."
              ></PersonaCard>
              <PersonaCard
                ...
                name="Cell Electrochemical Research"
              ...
              <PersonaCard
                ...
                rootClassName="rootClassName7"
                name="Cell Quality Check & Inspection"
              ...
              <PersonaCard
                ...
                rootClassName="rootClassName6"
                name="Cell Degradation & Ageing Analysis"
              ...
              <PersonaCard
                ...
                rootClassName="rootClassName8"
                name="Cell to Cell Techno Commercial Comparison"
                quote="Comparative analysis of various battery cell technologies from both technical and commercial perspectives to inform decision-making and optimization strategies."
              ></PersonaCard>
            </div>
